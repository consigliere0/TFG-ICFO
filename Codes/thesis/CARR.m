...
%% =========================================================================
% SECTION 4c: Figure 1c - Coincidence rates vs power in mW
% =========================================================================
fig1_mW = figure('Name', 'SPAD Coincidence Rates vs Pump Power in mW', ...
                  'Color', 'w', ...
                  'Position', [120 100 800 520]);
hold on; box on; grid on; grid minor;
...
hold off;
saveas(fig1_mW, fullfile(outFolder, ...
    'SPAD_Coincidence_Rates_vs_Power_mW.png'));
